...
export default function ComposeTweet({ onTweetCreated, placeholder = "What's happening?", replyTo = null }) {
  const { user } = useAuth();
      ...
      <div className="flex gap-3">
        ...
        <form onSubmit={handleSubmit} className="flex-1">
          ...
          <textarea
            ...
            className="w-full bg-transparent text-xl text-[#e7e9ea] placeholder-[#71767b] resize-none focus:outline-none min-h-[56px]"
            rows={1}
          />
          ...
          {showPollCreator && (
            <div className="mb-3 p-4 card">
              <input
                ...
                className="w-full bg-transparent border-b border-white/[0.08] pb-2 mb-3 text-[#e7e9ea] placeholder-[#71767b] focus:outline-none focus:border-[#a855f7]"
              />
              {pollOptions.map((option, index) => (
                <div key={index} className="flex items-center gap-2 mb-2">
                  <input
                    ...
                    className="flex-1 input-clean py-2"
                  />
                  {pollOptions.length > 2 && (
                    <button
                      type="button"
                      onClick={() => removePollOption(index)}
                      className="text-[#71767b] hover:text-red-400"
                    >
                      ×
                    </button>
                  )}
          ...
          <div className="flex items-center justify-between border-t border-white/[0.08] pt-3 mt-2">
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className={`p-2 rounded-full hover:bg-[#a855f7]/10 transition-colors ${showPollCreator ? 'text-[#a855f7] bg-[#a855f7]/10' : 'text-[#a855f7]'}`}
              >
                <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
